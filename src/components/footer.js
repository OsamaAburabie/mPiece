...
function Footer() {
  ...
  return (
    <>
      {/* component */}
      <div dir="rtl" className="bg-secondary">
        <div className="max-w-6xl m-auto text-primary flex flex-wrap justify-center">
          ...
          <div className="p-5 w-48 ">
            <div className="text-xs uppercase text-secondary font-medium">
              الرئيسية
            </div>
            <a className="my-3 block" href="/#">
              الخدمات <span className="text-teal-600 text-xs p-1" />
            </a>
            <a className="my-3 block" href="/#">
              حول <span className="text-teal-600 text-xs p-1" />
            </a>
            <a className="my-3 block" href="/#">
              الشركات
            </a>
          ...
          <div className="p-5 w-48 ">
            ...
            <a className="my-3 block" href="/#">
              تسجيل دخول <span className="text-teal-600 text-xs p-1" />
            </a>
            <a className="my-3 block" href="/#">
              تسجيل حساب جديد <span className="text-teal-600 text-xs p-1" />
            </a>
            <a className="my-3 block" href="/#">
              وظائف
            </a>
          ...
          <div className="p-5 w-48 ">
            ...
            <a className="my-3 block" href="/#">
              خدمة العملاء <span className="text-teal-600 text-xs p-1" />
            </a>
            <a className="my-3 block" href="/#">
              اتفاقية الخصوصية <span className="text-teal-600 text-xs p-1" />
            </a>
            <a className="my-3 block" href="/#">
              الشروط <span className="text-teal-600 text-xs p-1" />
            </a>
          </div>
          <div className="p-5 w-48 ">
            <div className="text-xs uppercase text-secondary font-medium">
      ...
      <div className="bg-secondary pt-2 ">
        <div
          className="flex pb-5 px-3 m-auto pt-5 border-t text-primary text-sm flex-col
        ...
        >
          ...
          <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
            <a href="/#" className="w-6 mx-1">
              <svg
                className="fill-current cursor-pointer text-secondary hover:text-gray-400"
                width="100%"
                height="100%"
                viewBox="0 0 24 24"
                version="1.1"
